...
HD_PWD='E:/xapp1247-multiboot-spi/Vivado/Update/Update.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log update_module.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source update_module.tcl -notrace
