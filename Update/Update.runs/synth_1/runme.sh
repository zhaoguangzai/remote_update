...
HD_PWD='E:/xapp1247-multiboot-spi/Vivado/Update/Update.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log update_module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source update_module.tcl
