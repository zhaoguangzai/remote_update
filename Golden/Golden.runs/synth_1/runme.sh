...
HD_PWD='E:/xapp1247-multiboot-spi/Vivado/Golden/Golden.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_mudule.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Top_mudule.tcl
