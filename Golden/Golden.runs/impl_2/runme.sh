...
HD_PWD='E:/xapp1247-multiboot-spi/Vivado/Golden/Golden.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log Top_mudule.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Top_mudule.tcl -notrace
